...
if (!process.env.TRELLO_API_KEY || !process.env.TRELLO_TOKEN) {
    process.stderr.write(`${pkg.name}: warning — TRELLO_API_KEY and/or TRELLO_TOKEN are not set. ` +
...
import { listBoardsTool, getBoardDetailsTool, getListsTool, handleListBoards, handleGetBoardDetails, handleGetLists, trelloFilterListsTool, handleTrelloFilterLists } from './tools/boards.js';
import { createCardTool, updateCardTool, moveCardTool, getCardTool, handleCreateCard, handleUpdateCard, handleMoveCard, handleGetCard, trelloArchiveCardTool, handleArchiveCard } from './tools/cards.js';
import { trelloSearchTool, handleTrelloSearch } from './tools/search.js';
import { trelloGetListCardsTool, handleTrelloGetListCards, trelloCreateListTool, handleTrelloCreateList, trelloAddCommentTool, handleTrelloAddComment } from './tools/lists.js';
import { trelloGetUserBoardsTool, handleTrelloGetUserBoards, trelloGetMemberTool, handleTrelloGetMember } from './tools/members.js';
import { trelloGetBoardCardsTool, handleTrelloGetBoardCards, trelloGetCardActionsTool, handleTrelloGetCardActions, trelloGetCardAttachmentsTool, handleTrelloGetCardAttachments, trelloGetCardChecklistsTool, handleTrelloGetCardChecklists, trelloGetBoardMembersTool, handleTrelloGetBoardMembers, trelloGetBoardLabelsTool, handleTrelloGetBoardLabels, trelloCreateLabelTool, handleTrelloCreateLabel, trelloUpdateLabelTool, handleTrelloUpdateLabel, trelloAddLabelToCardTool, handleTrelloAddLabelToCard, trelloRemoveLabelFromCardTool, handleTrelloRemoveLabelFromCard, trelloCreateCardAttachmentTool, handleTrelloCreateCardAttachment, trelloGetCardAttachmentTool, handleTrelloGetCardAttachment, trelloDeleteCardAttachmentTool, handleTrelloDeleteCardAttachment, trelloGetBoardCustomFieldsTool, handleTrelloGetBoardCustomFields, trelloAddMemberToCardTool, handleTrelloAddMemberToCard, trelloRemoveMemberFromCardTool, handleTrelloRemoveMemberFromCard, trelloDeleteLabelTool, handleTrelloDeleteLabel } from './tools/advanced.js';
import { trelloCreateChecklistTool, handleTrelloCreateChecklist, trelloGetChecklistTool, handleTrelloGetChecklist, trelloUpdateChecklistTool, handleTrelloUpdateChecklist, trelloDeleteChecklistTool, handleTrelloDeleteChecklist, trelloGetChecklistFieldTool, handleTrelloGetChecklistField, trelloUpdateChecklistFieldTool, handleTrelloUpdateChecklistField, trelloGetBoardForChecklistTool, handleTrelloGetBoardForChecklist, trelloGetCardForChecklistTool, handleTrelloGetCardForChecklist, trelloGetCheckItemsTool, handleTrelloGetCheckItems, trelloCreateCheckItemTool, handleTrelloCreateCheckItem, trelloGetCheckItemTool, handleTrelloGetCheckItem, trelloDeleteCheckItemTool, handleTrelloDeleteCheckItem, trelloUpdateCheckItemTool, handleTrelloUpdateCheckItem } from './tools/checklists.js';
