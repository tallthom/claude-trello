 ...
 */
export function extractTrelloId(input) {
...
export function extractCredentials(args) {
    if (args !== undefined && args !== null && typeof args !== 'object') {
        throw new Error('Tool arguments must be an object.');
    }
    const { apiKey: argApiKey, token: argToken, ...rest } = args ?? {};
...
export function validateListBoards(data) {
    return listBoardsSchema.parse(data);
}
export function validateGetBoard(data) {
    return getBoardSchema.parse(data);
}
export function validateGetBoardLists(data) {
...
export function validateMoveCard(data) {
    return moveCardSchema.parse(data);
}
export function validateGetCard(data) {
    return getCardSchema.parse(data);
}
export function validateDeleteCard(data) {
