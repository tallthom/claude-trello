...
import { listBoardsTool, handleListBoards, getBoardDetailsTool, handleGetBoardDetails, getListsTool, handleGetLists, trelloFilterListsTool, handleTrelloFilterLists } from './tools/boards.js';
import { createCardTool, handleCreateCard, updateCardTool, handleUpdateCard, moveCardTool, handleMoveCard, getCardTool, handleGetCard, trelloArchiveCardTool, handleArchiveCard } from './tools/cards.js';
...
export function createMCPServer() {
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        if (readOnly && WRITE_TOOL_NAMES.has(name)) {
            return {
                content: [{ type: 'text', text: `Error: Tool '${name}' is not available in read-only mode` }],
                isError: true
            };
        }
        switch (name) {
