...
const validateGetBoardCustomFields = (args) => {
    const schema = z.object({
        boardId: trelloIdSchema
    });
    return schema.parse(args);
};
const validateGetBoardCards = (args) => {
    const schema = z.object({
        boardId: trelloIdSchema,
...
const validateGetCardActions = (args) => {
    const schema = z.object({
...
const validateGetCardAttachments = (args) => {
    const schema = z.object({
        cardId: trelloIdSchema,
...
const validateGetCardAttachment = (args) => {
    const schema = z.object({
        cardId: trelloIdSchema,
...
const validateDeleteCardAttachment = (args) => {
    const schema = z.object({
        cardId: trelloIdSchema,
        attachmentId: z.string().min(1, 'Attachment ID is required')
    });
...
const validateGetCardChecklists = (args) => {
    const schema = z.object({
        cardId: trelloIdSchema,
...
const validateGetBoardMembers = (args) => {
    const schema = z.object({
        boardId: trelloIdSchema
    });
    return schema.parse(args);
};
const validateGetBoardLabels = (args) => {
    const schema = z.object({
        boardId: trelloIdSchema
    });
    return schema.parse(args);
};
const validateCreateLabel = (args) => {
    const schema = z.object({
        boardId: trelloIdSchema,
...
const validateUpdateLabel = (args) => {
    const schema = z.object({
...
const validateAddLabelToCard = (args) => {
    const schema = z.object({
        cardId: trelloIdSchema,
        labelId: trelloIdSchema
    });
...
const validateRemoveLabelFromCard = (args) => {
    const schema = z.object({
        cardId: trelloIdSchema,
        labelId: trelloIdSchema
    });
...
export const trelloGetBoardCardsTool = {
...
export async function handleTrelloGetBoardCards(args) {
    try {
...
export const trelloGetCardActionsTool = {
...
export async function handleTrelloGetCardActions(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloGetCardAttachmentsTool = {
...
export async function handleTrelloGetCardAttachments(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloGetCardChecklistsTool = {
...
export async function handleTrelloGetCardChecklists(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloGetBoardMembersTool = {
...
export async function handleTrelloGetBoardMembers(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloGetBoardLabels(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloCreateLabelTool = {
...
export async function handleTrelloCreateLabel(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloUpdateLabelTool = {
...
export async function handleTrelloUpdateLabel(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloAddLabelToCardTool = {
...
export async function handleTrelloAddLabelToCard(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloRemoveLabelFromCardTool = {
...
export async function handleTrelloRemoveLabelFromCard(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloCreateCardAttachment(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloGetCardAttachmentTool = {
...
export async function handleTrelloGetCardAttachment(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloDeleteCardAttachmentTool = {
...
export async function handleTrelloDeleteCardAttachment(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloGetBoardCustomFieldsTool = {
...
export async function handleTrelloGetBoardCustomFields(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
const validateAddMemberToCard = (args) => {
    const schema = z.object({
        cardId: trelloIdSchema,
...
const validateRemoveMemberFromCard = (args) => {
    const schema = z.object({
        cardId: trelloIdSchema,
        memberId: trelloIdSchema
    });
...
const validateDeleteLabel = (args) => {
    const schema = z.object({
        labelId: trelloIdSchema
    });
    return schema.parse(args);
};
export const trelloAddMemberToCardTool = {
...
export async function handleTrelloAddMemberToCard(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloRemoveMemberFromCardTool = {
...
export async function handleTrelloRemoveMemberFromCard(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloDeleteLabelTool = {
...
export async function handleTrelloDeleteLabel(args) {
    try {
        const { credentials, params } = extractCredentials(args);
