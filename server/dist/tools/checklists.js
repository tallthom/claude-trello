...
const validateGetChecklist = (args) => {
    const schema = z.object({
...
const validateUpdateChecklist = (args) => {
    const schema = z.object({
        checklistId: trelloIdSchema,
...
const validateDeleteChecklist = (args) => {
    const schema = z.object({
        checklistId: trelloIdSchema
    });
    return schema.parse(args);
};
const validateGetChecklistField = (args) => {
    const schema = z.object({
        checklistId: trelloIdSchema,
...
const validateUpdateChecklistField = (args) => {
    const schema = z.object({
        checklistId: trelloIdSchema,
        field: z.enum(['name', 'pos'], { errorMap: () => ({ message: 'Field must be "name" or "pos"' }) }),
...
const validateChecklistIdOnly = (args) => {
    const schema = z.object({
        checklistId: trelloIdSchema
    });
    return schema.parse(args);
};
const validateGetCheckItems = (args) => {
    const schema = z.object({
        checklistId: trelloIdSchema,
...
const validateCreateCheckItem = (args) => {
    const schema = z.object({
        checklistId: trelloIdSchema,
...
const validateGetCheckItem = (args) => {
    const schema = z.object({
        checklistId: trelloIdSchema,
...
const validateDeleteCheckItem = (args) => {
    const schema = z.object({
        checklistId: trelloIdSchema,
        checkItemId: trelloIdSchema
    });
...
const validateUpdateCheckItem = (args) => {
    const schema = z.object({
        cardId: trelloIdSchema,
        checkItemId: trelloIdSchema,
        name: z.string().min(1).optional(),
...
// --- Tool definitions ---
export const trelloCreateChecklistTool = {
...
export const trelloGetChecklistTool = {
...
export const trelloUpdateChecklistTool = {
...
export const trelloDeleteChecklistTool = {
...
export const trelloGetChecklistFieldTool = {
...
export const trelloUpdateChecklistFieldTool = {
...
export const trelloGetBoardForChecklistTool = {
...
export const trelloGetCardForChecklistTool = {
...
export const trelloGetCheckItemsTool = {
...
export const trelloCreateCheckItemTool = {
...
export const trelloGetCheckItemTool = {
...
export const trelloDeleteCheckItemTool = {
...
export const trelloUpdateCheckItemTool = {
...
// --- Handlers ---
export async function handleTrelloCreateChecklist(args) {
    try {
...
export async function handleTrelloGetChecklist(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloUpdateChecklist(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloDeleteChecklist(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloGetChecklistField(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloUpdateChecklistField(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloGetBoardForChecklist(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloGetCardForChecklist(args) {
    try {
        const { credentials, params } = extractCredentials(args);
        const { checklistId } = validateChecklistIdOnly(params);
        const client = new TrelloClient(credentials);
...
export async function handleTrelloGetCheckItems(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloCreateCheckItem(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloGetCheckItem(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloDeleteCheckItem(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleTrelloUpdateCheckItem(args) {
    try {
        const { credentials, params } = extractCredentials(args);
