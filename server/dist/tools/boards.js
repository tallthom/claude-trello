...
export const getBoardDetailsTool = {
...
export async function handleGetBoardDetails(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export async function handleGetLists(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
const validateFilterLists = (args) => {
...
export const trelloFilterListsTool = {
...
export async function handleTrelloFilterLists(args) {
    try {
        const { credentials, params } = extractCredentials(args);
