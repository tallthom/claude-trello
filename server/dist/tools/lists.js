...
const validateGetListCards = (args) => {
...
export const trelloGetListCardsTool = {
...
export async function handleTrelloGetListCards(args) {
    try {
...
export const trelloCreateListTool = {
...
export async function handleTrelloCreateList(args) {
    try {
        const { credentials, params } = extractCredentials(args);
...
export const trelloAddCommentTool = {
...
export async function handleTrelloAddComment(args) {
    try {
        const { credentials, params } = extractCredentials(args);
